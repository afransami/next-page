    ...
    <div className="my-container flex flex-col items-center justify-between lg:flex-row">
      ...
      <div className="mb-10 lg:max-w-lg  lg:pr-5 lg:mb-0">
        <div className="max-w-xl mb-6 lg:mt-8">
          <div className="badge badge-warning font-bold">On Sale!</div>
        ...
        <div className="flex flex-col items-center md:flex-row">
          <Link to="/books" className="info md:w-auto md:mr-4">
            <div className="inline-flex items-center justify-center w-full h-full">
              <button className="btn btn-info font-bold hover:bg-sky-500">
                Visit Store
                <span>
                  <ShoppingCartIcon className="w-5 text-black ml-1" />
                </span>
              </button>
            </div>
          </Link>
